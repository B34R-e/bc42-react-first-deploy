...
function Ref() {
    ...
    // Tác dụng 2: Để lưu trữ dữ liệu mà khi dữ liệu thay đổi component không cần hiển thị lại
  ...
  return (
    <div>
        ...
        <input ref={inputRef} className='form-control' placeholder='Username' onChange={handleSearch} />
